...
/// Reads and writes AI provider configuration in openhuman.json.
class ProviderConfigService {
  static const _configPath = '/root/.openhuman/openhuman.json';
  ...
  static Future<void> saveProviderConfig({
    ...
    // not a bare string. OpenHuman expects: models: [{ id: "model-name" }].
