...
class BootstrapService {
  ...
  Future<void> runFullSetup({
    ...
    try {
      ...
      // git: openhuman has git deps (@whiskeysockets/libsignal-node)
      ...
      // Step 4: Install OpenHuman (80-98%)
      _updateSetupNotification('Installing OpenHuman...', progress: 82);
      onProgress(const SetupState(
        step: SetupStep.installingOpenHuman,
        progress: 0.0,
        message: 'Installing OpenHuman (this may take a few minutes)...',
      ));
      // Install openhuman — fork/exec works now with our Termux-matching proot.
      await NativeBridge.runInProot(
      ...
      _updateSetupNotification('Verifying OpenHuman...', progress: 96);
      onProgress(const SetupState(
        step: SetupStep.installingOpenHuman,
        progress: 0.9,
        message: 'Verifying OpenHuman...',
      ));
      await NativeBridge.runInProot('openhuman --version || echo openhuman_installed');
      onProgress(const SetupState(
        step: SetupStep.installingOpenHuman,
        progress: 1.0,
        message: 'OpenHuman installed',
      ));
