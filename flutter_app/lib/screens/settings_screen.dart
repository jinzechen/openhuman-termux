...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      body: _loading
          ...
          : ListView(
              children: [
                ...
                ListTile(
                  title: const Text('OpenHuman'),
                  subtitle: Text(_status['openhumanInstalled'] == true
                      ? 'Installed'
                      : 'Not installed'),
                ...
                ListTile(
                  ...
                  subtitle: const Text('mithun50/openhuman-termux'),
                  leading: const Icon(Icons.code),
  ...
  Future<String> _getSnapshotPath() async {
    ...
    if (hasPermission) {
      ...
      return '$sdcard/Download/openhuman-snapshot.json';
    }
    // Fallback to app-private directory
    final dir = await getApplicationDocumentsDirectory();
    return '${dir.path}/openhuman-snapshot.json';
  }
  ...
  Future<void> _importSnapshot() async {
    try {
      ...
      // Restore openhuman.json into rootfs
      final openhumanConfig = snapshot['openhumanConfig'] as String?;
      if (openhumanConfig != null) {
        await NativeBridge.writeRootfsFile('root/.openhuman/openhuman.json', openhumanConfig);
      }
