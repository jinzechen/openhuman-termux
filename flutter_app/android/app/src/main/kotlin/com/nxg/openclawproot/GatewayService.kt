...
class GatewayService : Service() {
    companion object {
        const val CHANNEL_ID = "openhuman_gateway"
        ...
        gatewayThread = Thread {
            try {
                ...
                synchronized(lock) {
                    ...
                    gatewayProcess = pm.startProotProcess("openhuman gateway --verbose")
                }
                updateNotificationRunning()
    ...
    private fun stopGateway() {
        ...
        // handler to kill child processes (node.js / openhuman daemon) before proot
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Keeps the OpenHuman gateway running in the background"
            }
    ...
    private fun buildNotification(text: String): Notification {
        ...
        builder.setContentTitle("OpenHuman Gateway")
            .setContentText(text)
